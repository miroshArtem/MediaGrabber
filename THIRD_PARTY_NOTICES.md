...
MediaGrabber can install and execute the following third-party tools as separate runtime programs.
...
yt-dlp is distributed under the Unlicense.

- Project: https://github.com/yt-dlp/yt-dlp
- License: https://github.com/yt-dlp/yt-dlp/blob/master/LICENSE

Runtime versions and SHA-256 checksums are recorded in the installer configuration for each release.
